...
node_indices=`curl -s -XGET http://$hostname:10141/_cat/indices | grep 'converge-history-20' | awk '{print $3}'`
compliance_indices=`curl -s -XGET http://$hostname:10141/_cat/indices | grep 'compliance-20' | awk '{print $3}'`
...
node_records_per_minute=`/home/centos/collect_metrics/files/index_records.py $node_index $curtime $node_records`
compliance_records_per_minute=`/home/centos/collect_metrics/files/index_records.py $compliance_index $curtime $compliance_records`
